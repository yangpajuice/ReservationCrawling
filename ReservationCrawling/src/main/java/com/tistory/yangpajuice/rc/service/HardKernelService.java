...
public class HardKernelService implements IService {
	...
	public void start() {
		...
		try {
			...
			Map<String, WebPageItem> webPageItemListFromWeb = getWebPageItemFromWeb();
	...
	private Map<String, WebPageItem> getWebPageItemFromWeb() {
		Map<String, WebPageItem> rtnValue = new TreeMap<String, WebPageItem>(Collections.reverseOrder());
		...
		try {
			...
			if (configItemList != null && configItemList.size() > 0) {
				for (ConfigItem configItem : configItemList) {
					...
					Map<String, WebPageItem> tmpRtnValue = getWebPageItemFromWeb(doc);
					if (tmpRtnValue != null && tmpRtnValue.size() > 0) {
